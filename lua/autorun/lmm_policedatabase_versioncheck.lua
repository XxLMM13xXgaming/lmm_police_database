...
local version = "beta" -- DO NOT EDIT THIS!
local version_url = "https://raw.githubusercontent.com/XxLMM13xXgaming/lmm_police_database/master/version.txt" -- DO NOT EDIT THIS!
local update_url = "https://github.com/XxLMM13xXgaming/lmm_police_database" -- DO NOT EDIT THIS!
local update_ur = "https://raw.githubusercontent.com/XxLMM13xXgaming/lmm_police_database/master/versionur.txt" -- DO NOT EDIT THIS!
...
local addon_id = "LMMPD" -- DO NOT EDIT THIS
local addon_name = "Police Database" -- DO NOT EDIT THIS

if (SERVER) then
	require("tmysql4")

	AddCSLuaFile("lmm_policedatabase_config.lua")
	include("lmm_policedatabase_config.lua")
	include("lmm_policedatabase_mysqlconfig.lua")

	LMMPDdb, LMMPDerr = tmysql.initialize(LMMPDMYSQLConfig.host, LMMPDMYSQLConfig.username, LMMPDMYSQLConfig.password, LMMPDMYSQLConfig.database, LMMPDMYSQLConfig.port, nil, CLIENT_MULTI_STATEMENTS )

	if LMMPDerr != nil or tostring( type( LMMPDdb ) ) == "boolean" then
		MsgC( Color(255,0,0), "[Police Databse] Error connecting to the database!\n" )
		MsgC( Color(255,0,0), "[Police Databse] MySQL Error: " .. LMMPDerr.."\n")
	else
		MsgC(Color(0,255,0), "[Police Databse] Connected to the database!\n")
	end
